...
int main(void)
{
  ...
  while (1)
  {
    ...
    /* USER CODE BEGIN 3 */
	  //HAL_Delay(1000);
	  /*if (HAL_GPIO_ReadPin(Push_button_GPIO_Port, Push_button_Pin) != 0)
		  {
...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin : paralle_push_Pin */
  GPIO_InitStruct.Pin = paralle_push_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_EVT_RISING;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(paralle_push_GPIO_Port, &GPIO_InitStruct);
