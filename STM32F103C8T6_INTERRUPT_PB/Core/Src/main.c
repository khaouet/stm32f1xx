...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin : PUSH_BUTTON_INTERRUPT_Pin */
  GPIO_InitStruct.Pin = PUSH_BUTTON_INTERRUPT_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_IT_RISING;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(PUSH_BUTTON_INTERRUPT_GPIO_Port, &GPIO_InitStruct);
